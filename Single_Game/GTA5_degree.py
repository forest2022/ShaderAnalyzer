"""
degree distribution for each frame for GTA5
"""
...
for idx in range(10, 635, 1):# frame range
    fnum = '_f'+ str(idx)+'_'
    shadertypes = [m for m in os.listdir(path1) if m.startswith('all_edgelist_hash')]
    degreeDistribution_output= path1  + 'degree_distribution/' + fnum +"GTA5_degreeDistribution.csv"
    in_out_degree_output = path1 + 'degree_distribution/' + fnum +'GTA5_in_out_degree.csv'    
